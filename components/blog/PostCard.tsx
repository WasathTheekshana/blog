  ...
  return (
    <article className="group">
      <Link href={`/blog/${slug}`} className="block">
        <div className="border border-[var(--terminal-border)] bg-[var(--terminal-surface)] p-4 transition-all hover:border-[var(--terminal-green)] hover:shadow-[0_0_10px_rgba(63,185,80,0.1)]">
          ...
          <div className="pl-4 border-l-2 border-[var(--terminal-border)]">
            <h2 className="text-lg text-[var(--terminal-green)] group-hover:text-[var(--terminal-cyan)] transition-colors">
              {frontmatter.title}
            </h2>
